              ...
              _buildSectionCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildFlightDetailRow(Icons.attach_money, "Base Price", "\$${flight.price.toStringAsFixed(2)}", isBold: true),
                    _buildFlightDetailRow(Icons.confirmation_number, "Total Price", "\$${totalPrice.toStringAsFixed(2)}", isBold: true, isTotal: true),
                  ],
                ),
              ),
                ...
                child: ElevatedButton.icon(
                  onPressed: _isBookingInProgress
                    ...
                    if (_formKey.currentState!.validate()) {
                      final String flightId = DateTime.now().millisecondsSinceEpoch.toString();
